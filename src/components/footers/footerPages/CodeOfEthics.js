      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-9">
              ...
              <ul>
                ...
                <li>
                  <Link className="EthicsLink">
                    2. DECENTRALAND’S CODE OF ETHICS
                  </Link>
                </li>
                <li>
            ...
            <p className="FooterSubHeading">2. DECENTRALAND’S CODE OF ETHICS</p>
            <p className="footerText">
              This Code of Ethics applies to Decentraland and all of its
              affiliates or subsidiaries (the “Decentraland Group”). Our Values
              of integrity, responsibility, respect and pioneering are the
              simplest statement of who we are. They govern everything we do.
              Our reputation as a company that the users can trust is our most
              ...
              that’s why we publish this externally and expect all others who
              work with us to set themselves equally high principles.
            </p>
            ...
            <p className="footerText">
              ...
              Decentraland. They are mandatory for us, but we also publish them
              ...
              business. The Decentraland Compliance Team is responsible for
              guarantying the application of these Policies and Principles
              throughout the company. Keeping in mind the following Policies and
              Principles will help us to achieve the highest standards of
              compliance.
            </p>
            <p className="footerText">
              {" "}
            ...
            <p className="footerText">
              {" "}
              3.2 Compliance with Law Decentraland Group and its employees are
              required to know, respect and comply the laws and regulations of
              the countries in which we operate. Every employee shall act
              ethically and in compliance with applicable laws and regulations
              while carrying out the Decentraland's business. Decentraland has a
              zero tolerance policy for violations of applicable laws.
            </p>
            <p className="footerText">
              {" "}
            ...
            <p className="footerText">
              ...
              Compliance Team, to the email account compliance@decentraland.org.
              ...
              so no matter who he/she is reporting (even a superior).
              Decentraland aims to encourage employees to report potential
              breaches of the Codes of Ethics, not only once the act is
              committed.
            </p>
            <p className="footerText">
              {" "}
              ...
              personal devices. Decentraland will monitor and control the use of
              Decentraland’s property, which includes, but is not limited to,
              computer, tablet, cell phone and email accounts provided to you.
              All devices provided by Decentraland have a monitoring software to
              prevent the commission of illegal acts. Random checks will be made
              on all Decentraland’s devices
            </p>
            <p className="footerText">
              {" "}
              3.6 Employees Decentraland is committed to a working environment
              that promotes diversity and equal opportunity and where there is
              mutual trust, respect for human rights and no discrimination. We
              are committed to working with employees to develop and enhance
              each individual’s skills and capabilities, respect them, and
              maintain good communication with them. This Code of Ethics will be
            ...
            <p className="footerText">
              {" "}
              3.11 The Environment Decentraland is committed to promote
              environmental care, increase understanding of environmental issues
              and disseminate good practice inside the company with recycling
              procedures.
            </p>
            <p className="footerText">
              {" "}
              ...
              relationship with shareholders, employees, customers and the
              Decentraland Group as well as with the public and any governmental
              offices such as, for instance, supervisory authorities.
            </p>
            <p className="footerText">
              {" "}
            ...
            <p className="footerText">
              {" "}
              Decentraland shall conduct regular training procedures to make
              sure that everyone knows and understands the Code of Ethics. Our
              employees are the face of our Company and we train them to respect
              the Company’s principles and standards not only while working but
              also in their own life.
            </p>
            <p className="FooterSubHeading">
              {" "}
            ...
            <p className="footerText">
              {" "}
              6.1 Shareholders Decentraland will conduct its operations in
              accordance with internationally accepted principles of good
              corporate governance. We will provide timely, regular and reliable
              ...
              in accordance between all the companies in the Decentraland Group.
            </p>
            <p className="footerText">
              {" "}
              6.2 Competition Decentraland companies and employees will conduct
              their operations in accordance with the principles of fair
              competition and all applicable regulations. Every employee must
              comply with the laws of fair competition. Employees shall seek
              guidance from the legal department of their particular company
              within the Decentraland Group when in doubt.
            </p>
            <p className="footerText">
              {" "}
              6.3 Business Integrity – Gifts Decentraland does not give or
              receive, whether directly or indirectly, bribes or other improper
              payments or advantages for business or financial gain. One of our
            ...
            <p className="footerText">
              ...
              working for Decentraland are expected to avoid personal activities
              and financial interests which could conflict with their
            ...
            <p className="footerText">
              {" "}
              6.5 Public Activities Decentraland will co-operate with
              governments and other organizations, both directly and through
            ...
            <p className="footerText">
              Decentraland and its employees will ensure that Decentraland does
              not receive the proceeds of criminal activities. All employees
              must be alert to the suspicious transactions such as when third
              parties (i) make or ask for payments in a form outside the
              ordinary course of business; (ii) split payments from several
              companies to our company; (iii) make or ask for payments in cash
              when they are usually made by check or wire transfer; or (iv) make
              or ask for payments in advance when are not customary or required
              by contract.
            </p>
            <p className="footerText">
            ...
            <p className="footerText">
              ...
              for Decentraland and for individuals involved. Where illegal
              conduct is involved, these could include significant fines for
              Decentraland, imprisonment for individuals and significant damage
              to our reputation.
            </p>
            <p className="footerText">
              ...
              carrying out the Decentraland Group’s business will be subject to
